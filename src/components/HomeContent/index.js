...
class HomeContent extends React.Component {
  ...
  render() {
    if(!(this.props.currentTodo && this.props.currentTodo.id)) return null
    //const todoDetails = (this.props.currentTodo.TodoDetails)? this.props.currentTodo.TodoDetails : []
    return (
